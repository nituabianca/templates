...
//}
//
////int sumaFrunze(Nod* radacina,suma) {
////	int suma;
////	if (radacina != NULL) {
////		sumaFrunze(radacina->stanga);
////		sumaFrunze(radacina->dreapta);
...
//	printf("\nInaltime arbore: %d",calculInaltime(radacina));
//	//printf("\n%d", sumaFrunze(radacina,suma));
//
//	printf("\nCAUTARE\n");
